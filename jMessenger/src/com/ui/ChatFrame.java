...
public class ChatFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Encryption key :");

        encKey.setText("EKeY16Characters");

        jLabel9.setForeground(new java.awt.Color(255, 0, 51));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel9.setText("Key must be 16 charaters. Blank will be unencrypted");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(encKey, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(!msg.isEmpty() && !target.isEmpty()){
			...
			if(!encKey.getText().isEmpty()){
				String encryptKey = encKey.getText();
				char[] encKeyChar = encryptKey.toCharArray();
				if(encKeyChar.length == 16){
					//JOptionPane.showMessageDialog(null, "Enc!!!");
					//encrypt message here
					Crypt crypt = new Crypt(encryptKey);
					try {
						msg = crypt.encrypt(msg);
					} catch (Exception ex) {
						JOptionPane.showMessageDialog(null, "Error: Encryption failed");
					}
				}else{
					JOptionPane.showMessageDialog(null, "Message sent without enryption. Encryption key should be 16 characters.");
				}
    ...
    public javax.swing.JTextField encKey;
